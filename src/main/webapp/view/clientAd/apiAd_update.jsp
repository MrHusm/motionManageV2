        ...
        <div class="row-fluid">
            ...
            <div class="span10">
              <div class="hero-unit">
                ...
                <form id="form" action="<%=basePath%>/apiAd/updateApiAd" method="post">
                	<input type="hidden" name="id" value="${apiAd.id }"/>
	                <table class="table table-bordered table-hover">
	                	<tr>
	                		<th style="width:20%">广告API名称：</th>
	                		<td style="width:80%">
	                			<input type="name" name="name" value="${apiAd.name }" style="width:80%"/>
							</td>
	                	</tr>
	                	<tr>
	                		<th style="width:20%">备注：</th>
	                		<td style="width:80%">
	                			<input type="remark" name="remark" value="${apiAd.remark }" style="width:80%">
							</td>
	                	</tr>
	                </table>
	                <div align="center">
