              ...
              <div class="hero-unit">
                ...
                <form id ="form" action="<%=basePath%>/recharge/updateRecharge" method="post">
	                ...
	                <table class="table table-bordered table-hover">
	                	...
	                	<tr>
	                		<th>活动文案：</th>
	                		<td colspan="3"><input type="text" id="content" name="content" value="${recharge.content }" style="width:80%"/></td>
	                	</tr>
	                	<tr>
	                		<th>首页文案：</th>
	                		<td colspan="3"><input type="text" id="firstContent" name="firstContent" value="${recharge.firstContent }" style="width:80%"/></td>
	                	</tr>	                	
	                </table>
