              ...
              <div class="hero-unit">
                ...
                <form id ="form" action="<%=basePath%>/recharge/addRecharge" method="post">
	                ...
	                <table class="table table-bordered table-hover">
	                	...
	                	<tr>
	                		<th>活动文案：</th>
	                		<td colspan="3"><input type="text" id="content" name="content" style="width:80%"/></td>
	                	</tr>
	                	<tr>
	                		<th>首页文案：</th>
	                		<td colspan="3"><input type="text" id="firstContent" name="firstContent" style="width:80%"/></td>
	                	</tr>
	                </table>
	                <div>
	                   <input type="button" class="btn-info" name="bt" id="bt" value="添加" style="display:none" onclick="addRecharge()">
	                </div>
	                <jsp:include page="amount_first_type.jsp" flush="true" ></jsp:include>
	                <div align="center">
	                   <input type="button" class="btn-info" name="bt" value="添加" onclick="save()">
	                   <input type="button" class="btn-info" name="bt" value="返回" onclick="window.location.href='<%=basePath%>/recharge/listRecharge?firstFlag=1'">
	                </div>
                </form>
            </div><!--/span-->
          </div><!--/row-->
...
function addRecharge(){
   ...
   if($("#type4").is(":visible")){
	  recharge = $("#type"+4);
   }else if($("#type5").is(":visible")){
	  recharge = $("#type"+5);
   }else if($("#type7").is(":visible")){
	  recharge = $("#type"+7);
   }
   
   var repayType = $("#repayType").val(); 
   var isCashMoney = $("#isCashMoney").val();
   ...
   var td3 = "";
   if(repayType=="1"){
	   td2 = $("<th name='showTypeOne' style='display:none'></th>");
	   td3 = $("<td name='showTypeOne' style='display:none'></td>");
   }else{
	   td2 = $("<th name='showTypeOne'></th>");
	   td3 = $("<td name='showTypeOne'></td>");
   }
   
   var td4 = "";
   var td5 = "";
   if(repayType=="2" && isCashMoney=="1"){
	   td4 = $("<th name='showTypeTwo' style='display:none'></th>");
	   td5 = $("<td name='showTypeTwo' style='display:none'></td>");
   }else{
	   td4 = $("<th name='showTypeTwo'></th>");
	   td5 = $("<td name='showTypeTwo'></td>");
   }
   var td6 = $("<td></td>");
   td1.append("充值金额：<input type='text' name='amount'/>");
   td2.append("代金券ID：");
   td3.append("<input type='text' id='cashCouponId' name='cashCouponId' />");
   td4.append("赠送金额（单位：铜币）：");
   td5.append("<input type='text' id='money' name='money' />");
   td6.append("<input type='button' class='btn-info' value='删除' onclick='deleteRow(this)'>");
   row.append(td1);
   row.append(td2);
   row.append(td3);
   row.append(td4);
