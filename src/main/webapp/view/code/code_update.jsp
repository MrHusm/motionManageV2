    ...
    <script>
        ...
        function showMode(param){
        	if($(param).val() == '1'){
        		...
        		$("#form").attr("action", "<%=basePath%>/code/updateCode");
        	}else if($(param).val() == '2'){
        		$("#ccText").html("生成个数：");
        		$("#topNameTr").show();
        		$("#topName").attr("disabled",false);
        		$("#form").attr("action", "<%=basePath%>/code/updateCodeRule");
        	}
        }
                ...
                <form id ="form" method="post">
	                ...
	                <table class="table table-bordered table-hover">
	                		...
	                		<td style="width:35%">
			              	  <select name="type" id="type" onchange="showMode(this)">
			              	       <option value="">请选择</option>
			              	   	   <option value="1" ${type == '1' ? 'selected' : '' }>公共兑换码</option>	
			              	   	   <option value="2" ${type == '2' ? 'selected' : '' }>单一兑换码</option>
			              	   </select>
							</td>
	                	...
	                	<tr>
	                		...
	                		<td style="width:35%"><input type="text" id="cc" name="cc" value="${code.cc }"></td>
	                		<th>用户兑换个数限定：</th>
	                		<td><input type="text" id="userCc" name="userCc" value="${code.userCc }"></td>
	                	</tr>
	                	<tr>
	                		<th>绑定手机号：</th>
	                		<td>
	                	...
	                	<tr>
	                		...
	                		<th>包月ID：</th>
	                		<td><input type="text" id="byIds" name="byIds" value="${code.byIds }"></td>
	                	</tr>
	                	<tr style="display:none" id="topNameTr">
	                		<th>设定前6位：</th>
	                		<td><input type="text" id="topName" disabled="disabled" name="top_name" value="${topName }"></td>
	                		<th></th>
	                		<td></td>
	                	</tr>
	                	<tr>
