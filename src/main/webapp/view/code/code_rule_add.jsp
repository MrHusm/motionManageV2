...
<html lang="en"><head>
    ...
    <script>
	    $(function(){
	        var validate = $("#form").validate({
	            ...
	            messages:{
	                ...
	                userCc:{
	                	required:"请输入单个码单个用户兑换限定",
	                	digits:"单个码单个用户兑换限定必须为整数"
	                },
	                allCc:{
	                	required:"请输入单个码可兑换次数",
	                	digits:"单个码可兑换次数必须为整数"
	                },
	                startDate:{
	                	required:"请输入开始时间"
	                },
        ...
        function save(){
    		...
    		if(flag){
    			var allCc = $("#allCc").val();
    			var userCc = $("#userCc").val();
    			if(allCc < userCc){
    				alert("单个码可兑换次数必须大于等于单个码单个用户兑换限定!");
    				$("#allCc").focus();
    				return false;
    			}
    		}
        ...
        <div class="row-fluid">
            ...
            <div class="span10">
              <div class="hero-unit">
                ...
                <form id ="form" action="<%=basePath%>/code/addCodeRule" method="post">
	                <table class="table table-bordered table-hover">
	                	...
	                	<tr>
	                		<th style="width:15%"><span id="ccText">单个码可兑换次数：</span></th>
	                		<td style="width:35%"><input type="text" id="allCc" name="allCc"></td>
	                		<th>单个码单个用户兑换限定：</th>
	                	...
	                	<tr>
	                		...
	                		<th>设定兑换码前X位：</th>
	                		<td><input type="text" id="topName" name="top_name" maxlength="6"></td>
	                	</tr>
	                	<tr>
	                		<th>渠道限制：</th>
	                		<td>
