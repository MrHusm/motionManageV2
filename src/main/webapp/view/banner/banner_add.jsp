        ...
        <div class="row-fluid">
            ...
            <div class="span10">
              <div class="hero-unit">
                ...
                <form id ="form" action="<%=basePath%>/jpBanner/addBanner" method="post" enctype="multipart/form-data">
	                ...
	                <table class="table table-bordered table-hover">
	                	<tr>
	                		...
	                		<td style="width:35%"><input type="text" id="url" name="url"></td>
	                	</tr>
	                	<tr>
	                		<th>开始时间：</th>
	                		<td>
	                	...
	                	<tr>
	                		<th>广告内容</th>
	                		<td colspan="3"><input type="text" name="content" style="width:83%"/></td>
	                	</tr>
	                	</c:if>
	                	<tr>
	                		<th>备注</th>
	                		<td colspan="3"><input type="text" name="remark" style="width:83%"/></td>
	                	</tr>
	                	<tr>
	                		<th>渠道ID：</th>
	                		<td colspan="3"><input type="text" id="channels" name="channels" style="width:83%"></td>
	                	</tr>
	                	<tr>
	                		<th>版本选择：</th>
	                		<td colspan="3">
