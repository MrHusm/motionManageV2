        ...
        <div class="row-fluid">
            ...
            <div class="span10">
              <div class="hero-unit">
                ...
                <form id ="form" action="<%=basePath%>/phb/listPhbSon" method="post">
	...
	<table class="table table-bordered table-hover">
	  <thead>
    	<tr>
				...
				<th class="tb_title" width="100">榜单类型</th>
        </tr>
    </thead>
    	<tbody>
			<c:forEach var="phb" items="${list }">
	    	    <tr class="odd gradeX warning">
					...
					<td class="center"><a href="<%=basePath%>/book/listBook?phbid=${phb.id}&phb_name=${phb.name }&ids=${phb.bids }">查看</a>&nbsp;</td>
					<td class="center">
							<c:if test="${phb.css=='3'}">
							小图榜单
							</c:if>
