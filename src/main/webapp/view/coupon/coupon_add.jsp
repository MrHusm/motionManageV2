        ...
        <div class="row-fluid">
            ...
            <div class="span10">
              <div class="hero-unit">
                ...
                <form id ="form" action="<%=basePath%>/coupon/addCoupon" method="post">
	                	...
	                	<tr>
	                		...
	                		<td>
			              	  <select name="type" id="type" onchange="showDate(this)">
			              	   	   ...
			              	   	   <option value="1">自用户激活之日起</option>	
			              	   	   <option value="2">次月失效</option>
			              	   </select>
							</td>
	                		...
	                		<td name="showOne"  style="display:none">
								<input type="text" class="Wdate input" onFocus="WdatePicker({lang:'en',startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'endDate\')}',alwaysUseStartDate:true})"  style="width:40%" name="startDate" id="startDate">
								-<input type="text" class="Wdate input" onFocus="WdatePicker({lang:'en',startDate:'%y-%M-01',dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'startDate\')}',alwaysUseStartDate:true})"  style="width:40%" name="endDate" id="endDate">							
							</td>
							<th name="showTwo"  style="display:none">自用户激活之日起：</th>
	                		<td name="showTwo"  style="display:none"><input type="text" id="day" name="day"></td>
	                	</tr>
	                	<tr>
	                		<th>金额：</th>
