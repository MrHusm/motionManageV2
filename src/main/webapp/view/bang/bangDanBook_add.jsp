        ...
        <div class="row-fluid">
            ...
            <div class="span10">
              <div class="hero-unit">
                ...
                <form id ="form" action="<%=basePath%>/jpBangDBook/addBingDBook" method="post">
	                ...
	                <table class="table table-bordered table-hover">
	                	<tr>
	                		...
	                		<td style="width:35%" colspan="3">
			              	  <input type="text" name="bookId" style="width:81%"/>
							</td>
	                	</tr>
	                	<tr>
	                ...
	                <div align="center">
	                   ...
	                   <input type="button" class="btn-info" name="bt" value="返回" onclick="window.location.href='<%=basePath%>/jpBangDBook/listBangDBook?bangDanId=${bangDanId}&source=${source }'">
	                </div>
                </form> 
            </div><!--/span-->
          </div><!--/row-->
