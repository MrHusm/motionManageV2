        ...
        <div class="row-fluid">
            ...
            <div class="span10">
              <div class="hero-unit">
                ...
                <form id ="form" action="<%=basePath%>/jpBangd/addBingD" method="post">
	                ...
	                <table class="table table-bordered table-hover">
	                	<tr>
	                		...
	                		<td style="width:35%"><input type="text" id="bookNum" name="bookNum"></td>
	                	</tr>
	                	<tr>
	                	...
	                	<tr>
	                		...
	                		<td>
	                		   <select name="moreFlag" id="moreFlag" onchange="showMore(this)">
			              	   	   <option value="0">否</option>	
			              	   	   <option value="1">加载当前</option>
			              	   	   <option value="2">跳转</option>
			              	   	   <option value="3">换一批</option>
			              	   	   <option value="4">跳转频道</option>
			              	   </select>
	                		</td>
	                	</tr>
	                	<tr name="showMoreFlag" style="display:none">
	                		<th name="moreContentFlag" style="display:none">更多文案：</th>
	                		<td name="moreContentFlag" style="display:none"><input type="text" disabled="disabled" id="moreContent" name="moreContent"></td>
	                		<th name="moreUrlShow" style="display:none">更多链接：</th>
	                		<td name="moreUrlShow" style="display:none"><input type="text" disabled="disabled" id="moreUrl" name="moreUrl">(1重磅2男频3女频4出版)</td>
	                	...
	                	<tr>
	                		<th>排重榜单ID：</th>
	                		<td colspan="3"><input type="text" name="otherIds" /></td>
	                	</tr>
	                </table>
	                ...
	                <div align="center">
	                   ...
	                   <input type="button" class="btn-info" name="bt" value="返回" onclick="window.location.href='<%=basePath%>/jpBangd/listBangD'">
	                </div>
                </form> 
            </div><!--/span-->
          </div><!--/row-->
