        ...
        <div class="row-fluid">
            ...
            <div class="span10">
              <div class="hero-unit">
                ...
                <form id ="form" action="<%=basePath%>/registGift/addRegistGift" method="post">
	                <table class="table table-bordered table-hover">
	                	<tr>
	                		<th style="width:15%">方案名称：</th>
	                		<td style="width:35%"><input type="text" name="name" /></td>
	                	...
	                	<tr>
	                		...
	                		<td style="width:35%"><input type="text" name="num" /></td>
	                		<th style="width:15%">弹窗文案：</th>
	                		<td style="width:35%"><input type="text" name="content" /></td>
	                	</tr>
	                	<tr>
	                		<th>开始时间：</th>
	                		<td>
	                	...
	                	<tr>
	                		...
	                		<td colspan="3">
								<input type="text" name="channelIds" style="width:83%"/>
							</td>
	                	</tr>	                	
	                </table>
	                <div align="center">
