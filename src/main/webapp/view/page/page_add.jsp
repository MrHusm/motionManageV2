        ...
        <div class="row-fluid">
            ...
            <div class="span10">
              <div class="hero-unit">
                ...
                <form id ="form" action="<%=basePath%>/jpPage/addJpPage" method="post">
	                ...
	                <table class="table table-bordered table-hover">
	                	...
	                	<tr>
	                		<th style="width:15%">ID列表：</th>
	                		<td style="width:35%">
								<input type="text" name="ids" />（例：1712,2231,1122,2112）
							</td>
	                	</tr>	                	
	                </table>
	                <div align="center">
	                   <input type="submit" class="btn-info" name="bt" value="添加">
	                   <input type="button" class="btn-info" name="bt" value="返回" onclick="window.location.href='<%=basePath%>/jpPage/listPage?pageType=${pageType }&source=${source }'">
	                </div>
                </form> 
            </div><!--/span-->
          </div><!--/row-->
